...
<c:url var="APIurl" value="/api/blog/category" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="font-weight-bold text-danger">Blog Category</h1>
				</div>
				<div class="col-sm-6">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-header bg-primary text-white">
					<h5 class="modal-title" id="title-modal">Add New Blog
						Category</h5>
	...
	<script>
		...
		function clickAddPhotoCategory(){
			$('#title-modal').text("Add New Blog Category");
			$('#name').text("");
			id = -1;
		}

		function clickUpdatePhotoCategory(Id,Name){
			$('#title-modal').text("Update Blog Category");
			$('#name').text(Name);
			id = Id;
		}
