...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			...
			<div class="info">
				<a href='<c:url value=""/>' class="d-block">Lưu
					Bá Minh<%-- ${USERMODEL.fullName} --%>
				</a>
			</div>
		</div>
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item"><a
					href='<c:url value="/admin/testcategory"/>' class="nav-link">
						<i class="nav-icon fas fa-table"></i>
						<p>Test category</p>
				</a></li>
				<li class="nav-item"><a
					href='<c:url value="/admin/test"/>' class="nav-link">
